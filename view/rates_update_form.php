...
<body>
    <main>
		<div class="container">
            <a style="float: right;" href="deconnexion.php">
                <button  type="" class="btn btn-danger" name="deconnexion" style="margin-top:10px">Déconnexion</button>
            </a>
            <a style="float: right;" href="student_avis.php">
                <button  type="" class="btn btn-primary" name="deconnexion">Avis donnés</button>
            </a>
            <div class="row">
